...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "SELECT * FROM customers WHERE Cus_email = '$email'";
            ...
            if (count($errors) > 0) {
                ...
                $sql = "INSERT INTO customers (Cus_name,Cus_address, Cus_tel, Cus_email, password) VALUES ( ?, ?, ?, ?, ? )";
                $stmt = mysqli_stmt_init($conn);
                $prepareStmt = mysqli_stmt_prepare($stmt, $sql);
                if ($prepareStmt) {
                    mysqli_stmt_bind_param($stmt, "sssss", $name, $address, $tel, $email, $passwordHash);
