...
<body>
    ...
    <div class="show-program">
        <h2>
            <a href="Movie-Showing.php" style="text-decoration: none; color: rgb(0, 0, 0, 0.2); float: left;"
                onmouseover="this.style.color='rgb(0, 0, 0)'" onmouseout="this.style.color='rgb(0, 0, 0, 0.2)'">
                <strong>กำลังฉาย</strong>
            </a>
        </h2>
        <h2>
            <a href="Movie-Coming.php" style="text-decoration: none; color: rgb(0, 0, 0); margin:0 30px">
                            ...
                            while ($result = mysqli_fetch_array($query2, MYSQLI_ASSOC)) {
                                ...
                                <div class="ml-box">
                                    ...
                                    <div class="mlb-seemore">
                                        <a href='Movie2.php? Movie_id=<?php echo $result["Movie_id"]; ?>' ;> ดูเพิ่มเติม
                                        </a></br>
                                    </div>
                                </div>
